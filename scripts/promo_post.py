"""
HealthyLifeHub - Gumroad Promotional Post Generator v2
...
PROMO_PRODUCTS = [
    {
        ...
        "price": "$6.99",
        "slug": "meal-planner",
        "desc": "Plan healthy meals effortlessly with our comprehensive Notion meal planner.",
        "keywords": ["meal planning", "healthy eating", "diet planning", "nutrition"],
    },
    {
        "name": "Habit Tracker",
        "price": "$5.99",
        "slug": "habit-tracker",
        "desc": "Build healthy habits with our beautiful Notion habit tracker.",
        "keywords": ["habit tracking", "wellness routine", "health goals", "daily habits"],
    },
]

PROMO_SYSTEM_PROMPT = """You are an expert health and wellness writer.
