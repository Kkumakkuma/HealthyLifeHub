"""
HealthyLifeHub - Gumroad Promotional Post Generator
...
PROMO_PRODUCTS = [
    {"name": "Habit Tracker", "price": "$5.99", "slug": "habit-tracker", "desc": "Build lasting healthy habits with our visual Notion habit tracker."},
    {"name": "Meal Planner", "price": "$6.99", "slug": "meal-planner", "desc": "Plan healthy meals for the week and auto-generate grocery lists."},
]
